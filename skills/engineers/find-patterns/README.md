...
- As a research step within `feature` planning
...
**Claude Code:**
```
/find-patterns background job with retry logic
/find-patterns API client with authentication
/find-patterns pagination
```

**Other tools:**
```
@find-patterns <feature, pattern, or concept>
```
