...
- As a research step before running `feature`
...
**Claude Code:**
```
/analyze-code app/services/payment_processor.rb
/analyze-code VideoPublisher
/analyze-code user authentication flow
```

**Other tools:**
```
@analyze-code <file path, class name, or feature name>
```
