...
git status
# invoke 3_implement skill with the plan file path
```
```
...
1. Commit all meaningful changes using the `9_commit` skill
...
To resume: invoke the 6_resume_work skill with [sessions_dir][NNN_feature.md]
```
